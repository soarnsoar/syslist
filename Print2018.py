...
for group in group_dict:
    ...
    submit='(mkdir -p run_2018_indep_'+group+';cd run_2018_indep_'+group+';combineTool.py -m "115, 120, 125, 130, 140, 160, 180, 200, 250, 300, 350, 400, 450, 500, 550, 600, 650, 700, 750, 800, 850, 900,\
 950, 1000, 1100, 1200, 1300, 1400, 1500, 1600, 1700, 1800, 1900, 2000, 2100, 2200, 2300, 2400, 2500, 2600, 2700, 2800, 2900, 3000, 3200, 3400, 3600, 3800, 4000, 4200, 4400, 4600, 4800, 5000" -M Asymptot\
icLimits --rAbsAcc 0 --setParameters sigma=0,fvbf=0.5 --run expected -d ../output/WS2018.indep.root --job-mode "condor" --sub-opts "accounting_group=group_cms" --boundlist ../../scripts/mssm_HWW_boundari\
es_v5.json '+freeze+') &> logs/submit_'+group+'.log'
    print '---',group,'---'
    print submit
